...
import { ActivateSeatingPlanDocument } from "@/lib/graphql/generated";
...
export async function POST(
  ...
  try {
    ...
    await waitForPlanStatus(request, planId, "active");
    ...
    return NextResponse.json(
      { error: { message: error instanceof Error ? error.message : "Failed to activate plan." } },
