  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="grid min-h-[calc(100vh-9rem)] overflow-hidden rounded-3xl border border-line bg-card lg:grid-cols-[minmax(0,1fr)_540px]">
        <section className="relative hidden overflow-hidden lg:flex lg:flex-col lg:justify-between lg:bg-[linear-gradient(160deg,oklch(0.13_0.005_260)_0%,oklch(0.22_0.04_280)_60%,oklch(0.32_0.08_30)_100%)] lg:px-14 lg:py-12 lg:text-white">
          ...
          <div className="relative flex flex-col gap-10">
            ...
            <div className="max-w-md space-y-5">
              <h2 className="text-5xl font-semibold tracking-[-0.03em] text-white">
                Buy the ticket.
                <br />
                Take the ride.
              </h2>
          ...
          <div className="relative space-y-3">
            {[
              ...
              <div key={benefit} className="flex items-center gap-3 text-sm text-white/82">
                <span className="inline-flex size-5 items-center justify-center rounded-full border border-white/25 text-xs">
                  *
                </span>
                <span>{benefit}</span>
              </div>
