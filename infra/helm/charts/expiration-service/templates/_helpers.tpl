...
*/}}
{{- define "expiration-service.fullname" -}}
...
*/}}
{{- define "expiration-service.labels" -}}
...
*/}}
{{- define "expiration-service.selectorLabels" -}}
app.kubernetes.io/name: {{ .Chart.Name }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
...
*/}}
{{- define "expiration-service.serviceAccountName" -}}
{{- .Values.serviceAccount.name | default (include "expiration-service.fullname" .) }}
{{- end }}
...
*/}}
{{- define "expiration-service.image" -}}
